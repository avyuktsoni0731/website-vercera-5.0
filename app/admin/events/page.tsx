            ...
            >
              <div>
                ...
                <p className="text-sm text-foreground/60 mt-0.5">
                  {event.category} · Max {event.maxParticipants} · Fee ₹
                  {event.registrationFee}
                </p>
              </div>
              <div className="flex gap-6 text-sm">
                <div>
                  <p className="text-foreground/50">Registrations</p>
                  <p className="font-semibold text-foreground">{stats.count}</p>
                </div>
                <div>
                  <p className="text-foreground/50">Revenue</p>
                  <p className="font-semibold text-accent">
                    ₹{stats.revenue.toLocaleString('en-IN')}
                  </p>
                </div>
                <div>
                  <p className="text-foreground/50">Attended</p>
              ...
              >
                View registrations <ExternalLink className="h-3 w-3" />
              </Link>
            </div>
          )
        })}
